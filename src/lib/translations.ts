export const translations = {
  en: {
      ...
      projects: [
        {
          ...
          url: 'https://fortunewallpaper.com',
    ...
    contact: {
      title: 'GET IN TOUCH',
      greeting: 'Feel free to reach out anytime.',
    ...
    fortune: {
      heroLine1: 'Boost your positive',
      heroLine2: 'energy every day',
      subtitle1: 'Fortune readings with lucky wallpapers',
      subtitle2: 'boost luck and energy all day long.',
      servicesTitle: 'Our Services',
      cardDaily: 'Daily reading',
      cardPersonal: 'Personal reading',
      cardTarot: 'Tarot reading',
      visitSite: 'Visit Fortune Wallpaper',
      visitHint: 'Opens the live Fortune Wallpaper web app',
      tapHint: 'Tap a card to flip · tap again to open',
      ctaButton: 'Start fortune reading',
    },
    cardgame: {
  ...
  th: {
    ...
    fortune: {
      heroLine1: 'เสริมพลังดีๆ',
      heroLine2: 'ให้ทุกวันของคุณ',
      subtitle1: 'ทำนายดวง พร้อมวอลเปเปอร์มงคล',
      subtitle2: 'เสริมโชค เสริมดวง ตลอดทั้งวัน',
      servicesTitle: 'บริการของเรา',
      cardDaily: 'ทำนายรายวัน',
      cardPersonal: 'ทำนายส่วนบุคคล',
      cardTarot: 'เปิดไพ่ทำนาย',
      visitSite: 'ไปที่ Fortune Wallpaper',
      visitHint: 'เปิดเว็บแอป Fortune Wallpaper จริง',
      tapHint: 'แตะการ์ดเพื่อพลิก · แตะอีกครั้งเพื่อเปิดเว็บ',
      ctaButton: 'เริ่มทำนายดวง',
    },
    cardgame: {
